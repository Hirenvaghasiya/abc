...
<a href="ajax-chat/ajax-chat.html"><img src="live-chat.png" height="100" width="160"  style="margin-left:950px;"></a>
        ...
        <form action="index.php" method="post" name="login_form">
 		...
 		<?php
			if(isset($_POST['submit_login']))
			{
				...
				{
		?>
        	<div style="background-color:#000; color:#F00;" id="err"><?php echo "Invalid Username/Password";?> </div>
        <?php
				}
			}
		?>
...
<!--  -----------------------------------------------------------------------------------------------------------------------------------------  -->       
        ...
        <ul class="tab-menu-picture-list" style="float:left;  overflow-y:auto; height:300px">
		   ...
		   ?>
           <li>
          		<a class="ajaxpicture" href="uploads/<?php echo $res4['que_id'];?>.jpg"><img href="uploads/<?php echo $res4['que_id'];?>.jpg" alt=""/></a>
      ...
      <div class='tabslider'>
		...
		?>
          ...
          <span class="tab-date" style=" margin-top:-15px;"><?php echo $res1['date']; ?></span><a href="#" class="tab-menu-link" style=" margin-bottom::-40px;"><?php echo $res1['title']; ?></a><br/>
             ...
             <a href="answer.php?id=<?php echo $res1['artical_id']; ?>&que=<?php echo $res1['title'];?>&op=post" class="middle-button" style="float:right; margin-right: 	">
...
<!--  -----------------------------------------------------------------------------------------------------------------------------------------  -->       
        ...
        <a href="answer.php?id=<?php echo $res2['artical_id']; ?>&que=<?php echo $res2['title'];?>&op=post" class="middle-button" style="float:right; margin-right: 	">
...
<!--  -----------------------------------------------------------------------------------------------------------------------------------------  -->       
        ...
        <?php 
			...
			{			
		?>
          <li><span class="tab-date" style=" margin-top:-15px;"><?php echo $res1['date']; ?></span><a href="#" class="tab-menu-link" style=" margin-top:-15px;"><?php echo $res1['title']; ?></a><br/>
           <a href="answer.php?id=<?php echo $res1['artical_id']; ?>&que=<?php echo $res1['title'];?>&op=post" class="middle-button" style="float:right; margin-right: 	">
          			<span class="middle-right"></span>
             Panding
           </a>
