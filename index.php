...
<div class="grid_4" id="login-signup">
  <a href="" id="homepage-login-button" class="green-button">
  		<span class="green-right"></span>
        		</a>
                
                
  <a href="" id="homepage-signup-button" class="red-button">
 		...
 		<?php
			if(isset($_POST['submit_login']))
			{
				...
				if(mysql_num_rows($tmp)==1)
				{
					...
					mysql_query("insert into login_log values($_SESSION[user_id],'$date')") or die(mysql_error());
					header("location:welcome.php");
					}
					else
					{
						header("location:confirm_acc.php?op=confirm");
					}
				}
				else
				{
		?>
        	<div style="background-color:#000; color:#F00;"><?php $err= "Invalid Username/Password";?> </div>
        <?php
				}
			}
		?>
...
<?php
	...
	{
	?>
    <div style="margin-top:-400px; background-color:#CF6; width:350px;"><p style="font-size:24px; font-family:'Courier New', Courier, monospace; color:#F00;"><?php  echo $err;unset($err); ?></p></div>
    <?php
...
<!--  -----------------------------------------------------------------------------------------------------------------------------------------  -->       
		...
		?>
         <li><a class="ajaxpicture" href="uploads/<?php echo $res1['user_id'];?>.jpg"><img src="uploads/<?php echo $res1['user_id'];?>.jpg" alt="" height="50px" width="50"/></a>
          <span class="tab-date" style="margin-top:0px;"><?php echo $res1['date']; ?></span><a href="#" class="tab-menu-link" style=" margin-top:-15px;"><?php echo $res1['que']; ?></a><br/>
...
<!--  -----------------------------------------------------------------------------------------------------------------------------------------  -->       
		...
		?><br/>
           <li><a class="ajaxpicture" href="uploads/<?php echo $res2['user_id'];?>.jpg"><img src="uploads/<?php echo $res2['user_id'];?>.jpg" alt="" height="50px" width="50"/></a>
         	 <span class="tab-date"><?php echo $res2['date'];?></span></span>
   ...
   <font face="Times New Roman, Times, serif" size="+1">
   				<tr>
                    ...
                    <td><p class="box" style="height:40px; width:130px;"><a href="contact.php" style=" margin-left:25px; color: #FFF;"> 
                      <h4 style=" margin-top:-30px;"> Contact US</h4></a></p></td>
               
                    <td><p class="box" style="height:40px; width:130px;"><a href="about_us.php" style=" margin-left:25px; color: #FFF;">  
                      <h4 style=" margin-top:-30px;"> About US </h4></a> </p></td>
                      
                    <td><p class="box" style="height:40px; width:130px;"><a  href="Privacy policy.php" style=" margin-left:15px; color: #FFF;"> 
                      <h4 style=" margin-top:-30px;"> Privacy Policy</h4></a> </p></td>
                      
                 <td><p class="box" style="height:40px; width:130px;"><a  href="devlopers.php" style=" margin-left:15px; color: #FFF;"> 
                      <h4 style=" margin-top:-30px;"> Devlopers</h4></a> </p></td>
