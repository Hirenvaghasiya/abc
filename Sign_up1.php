...
<?php 
		...
		if(isset($_POST['submit']))
		{
			...
			else
			{
				   ...
				   //$link="confirm_acc.php";
				   //$mesaage="welcome to Ask4U.com Your Confirmation code is $code ";
   ...
   // mail($email,$subject,$message,"From: $from\n");
				...
				header("location:http://www.ask4u.hostoi.com/email_send.php?to=$email&code=$code");
			}
