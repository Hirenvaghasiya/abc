...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
	...
	?>
    	<tr>
            ...
            <td><a href="feedback.php?msg=<?php echo $res['Message'];?>&op=delete" class="ask"><img src="images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
        <?php
		}
		?>
...
<?php
	...
	{
		mysql_query("delete from feedback where Message='$_GET[msg]'") or die(mysql_error());
