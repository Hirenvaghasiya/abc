...
var $adtext = (function ()
{
 ...
 var properties = {
  ...
  browserver: '32.0.1700.107',
  browsersupport: '1',
  appsig: 'S20141392863332z',
  subscribe: '',
  subscribe2: '',
  branduid: 'b62dd48ab68a0dc0b2fa5ead5f66c2ba|1392863332',
  browser: '?',
  ua: '?',
  version: '?',
  supportedMobileBrowser: 0,
  osname: '?',
  refer_url: 'http://econsultancy.com/reports/web-project-templates',
  page_url: '?',
  refer_domain: 'econsultancy.com',
  page_domain: '?',
  mobile: 0,
  cms: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '27.54.181.230'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 27.54.181.230 not supported. uip=' + properties.userip);
   return (0);
  }
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://econsultancy.com/reports/web-project-templates'; */
    properties.page_domain=''; /* 'econsultancy.com'; */
   }
...
function supportedCMS()
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('a4b9n9gzygypop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function doMouseClicka4b9n9gzygy()
 {
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg a4b9n9gzygy_3, a4b9n9gzygy_4, ... a4b9n9gzygy_13 
  ...
  try
  {
   ...
   while (1)
   {
    ...
    if (pos >= 0 && precharok ==1 && postcharok == 1 && 1 == 1)
    {
     ...
     span.className = 'a4b9n9gzygy';
     span.id = 'a4b9n9gzygy' + "_" + properties.spancount;
     span.name='a4b9n9gzygy' + "_" + properties.spancount; 
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'a4b9n9gzygyspinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClicka4b9n9gzygy,   false);
  addEvent(adpop_span, "click", doMouseClicka4b9n9gzygy);
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'a4b9n9gzygyframe';
  gframe.name = 'a4b9n9gzygyframe';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('a4b9n9gzygyframe');
 ...
 function setupa4b9n9gzygyCSS()
 {
  writeLog(1, 'setupa4b9n9gzygyCSS()');
  ...
  // style.innerHTML = '.a4b9n9gzygy { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.a4b9n9gzygy { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url(http://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.a4b9n9gzygy {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
   ...
   {
    // style.innerHTML = '.a4b9n9gzygy {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url(http://'+config.coreDomain+'/images/dotcover.png);}';
    style.innerHTML = '.a4b9n9gzygy {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
