...
<title>Recent Question | Ask4u</title>
...
<li><a   href="All_questions.php"><u>All Answeres</a><!-- Begin Home Item -->
 ...
 <!--    <div class="search">
  ...
  <div class="grid_16 blog-page">
	...
	<div style="height:400px; float:left; overflow-y:auto; width:900px; margin-left:-50px;">
    <table border="1" >
   <?php 
   			include("cnn.php");
			$qry_qns="select * from question order by lastmodified desc limit 30";
			$tmp1=mysql_query($qry_qns) or die(mysql_error());
			while($res=mysql_fetch_assoc($tmp1))
			{
