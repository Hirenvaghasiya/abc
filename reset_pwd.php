...
<li><a   href="All_questions.php"><u>All Answeres</a><!-- Begin Home Item -->
 ...
 <!-- <div class="grid_2 nav-button">
  ...
  <?php
	...
	{
  		echo "<p style=color:green; font-size:20px;>Password Send into your Email	</p>";
	}
  ?>
  <div class="forgetpasscode">
                         <form action="reset_pwd.php" method="POST" name="forgetpassword">
                         <table>
                             <tr>
                                 <td style="color:darkgreen;font-size:25px;font-weight:bold;"><u>Forget Your Password?</u></td>
                             </tr>
                             <tr><td style="padding-top:40px;">
                                     <p style="font-weight:bold;margin-bottom:5px;">Get Help Retrieving Your Password By following These Steps:</p>
                                     <p>&blacktriangleright;Enter primary E-mail address you use in sign in Tool.</p>
                                     <p style="margin-top:-15px;">&blacktriangleright;Click 'Send Password' button.</p>
                                     <p style="margin-top:-15px;">&blacktriangleright;Instruction will be send your email account.</p>
                                 </td></tr>
                             <tr><td style="padding:20px 0 10px 0;font-weight:bold;">Enter Your Email Address</td></tr>
                             <tr><td class="forgettxt"><input type="email" name="txtemail" id="forgetemail" /></td></tr>
                             <tr><td class="forgetbtn"><input type="submit" name="next_sub" id="emailsubmit" value="Send Password" /></td></tr>
                         </table>
                         </form>
                         </div>
  <?php
  	if(isset($_POST['next_sub']))
	{
		...
		{
		?>
        <div style="margin-top:-275px; margin-left:20px; width:700px">
        <p style="color:#F00; font-size:16px;"><?php echo "Error:-No User Found For $email";?></p>
        </div>
		<?php	 
		}
		else
