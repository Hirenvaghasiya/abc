...
<li><a   href="All_questions.php"><u>All Answeres</a><!-- Begin Home Item -->
 ...
 <!-- <div class="grid_2 nav-button">
  ...
  <!-- Emty Grid -->
  <div class="grid_5" style="margin-left:100px; margin-top:-100px">
  <table>
  <tr>
  <td style="border-bottom-left-radius:10px; border-bottom-right-radius:10px; border:solid; border-color:#999; border-width:5px">
  <a rel="picture-album" href="devlopers/hiren.jpg" title=""><img src="devlopers/hiren.jpg" width="300" height="400" alt="" /></a>
  </td>
  <td >
  <a rel="picture-album" href="devlopers/jay.jpg" title=""><img src="devlopers/jay.jpg" style="margin-left:70px;" width="300" height="400" alt="" /></a>
  </td>
  </tr>
  <tr>
  <td><h1 style="margin-left:20px; font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif; color:#09F">Hiren N Vaghasiya</h1></td>
  <td><h1 style="margin-left:90px; font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif; color:#09F">Jay J Vataliya</h1></td>
  </tr>
  <tr>
  <td colspan="2"><h2>We create this website as part of our Bachelor Of Computer Application [B.C.A] Project In the Yeae of 2014 At Shree S.V.Patel Collage Of Computer science & Business Management, Surat </h2> </td>
  </tr>
  </table>
  </div>  
