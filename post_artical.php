    ...
    <!-- Elements-->
      ...
      <script type="text/javascript">
		...
		<form action="post_artical.php" method="post" enctype="multipart/form-data">
       	<h1>Email:-&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="email" name="txtemail" required style="height:35px; width:400px"/></h1>
        <h1>
        ...
        <input type="submit" name="sub_artical" value="POST ARTICAL" style="width:170px; height:35px; color:white;" class="button"/>
        <br>
