...
<div id="main_container">
    ...
    <div class="main_content" >
                    ...
                    <li><a href="list.html">View All  Answers<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <ul>
                        <li><a href="" title="">All Questions</a></li>
                        <li><a href="" title="">All Answers</a></li>                       </ul>
                    <!--[if lte IE 6]></td></tr></table></a><![endif]-->
                    </li>
                    
                   
                    <li><a href="list.html">View All  Articles<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <ul>
                        <li><a href="" title="">All Questions</a></li>
                        <li><a href="" title="">All Answers</a></li>                       </ul>
                   ...
                   <!--      <li><a href="" title="">Lorem ipsum dolor sit amet</a></li>
                    ...
                    <li><a href="login.html">Feed Back<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <!--<ul>
                        <li><a href="" title="">Lorem ipsum dolor sit amet</a></li>
                        <li><a href="" title="">Lorem ipsum dolor sit amet</a></li>
    ...
    <div class="left_content">
            ...
            <div class="sidebarmenu">
                ...
                <div class="submenu">
                    <ul>
                    <li><a href="">All Pending Articles</a></li>
                    <li><a href="">All Posted Articles</a></li>
                    </ul>
                </div>
                ...
                <div class="submenu">
                    ...
                    <li><a href="">Regular users</a></li>
                    </ul>
                </div>
                <a class="menuitem" href="">Feed Back</a>
                <a class="menuitem" href="">FAQ'Z</a>
                
                <a class="menuitem_green" href="">Conatact</a>
                
                <a class="menuitem_red" href="">Advertisement</a>
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    ...
    <tbody>
	 ...
	 <a href="#" class="bt_green"><span class="bt_green_lft"></span><strong>New users</strong><span class="bt_green_r"></span></a>
     <a href="#" class="bt_blue"><span class="bt_blue_lft"></span><strong>Regular Users</strong><span class="bt_blue_r"></span></a>
     <a href="#" class="bt_red"><span class="bt_red_lft"></span><strong>Delete User</strong><span class="bt_red_r"></span></a> 
         ...
         <form action="" method="post" class="niceform">
                ...
                <fieldset>
                    <dl>
                        ...
                        <dd><input type="text" name="user_id" id="" size="54" /></dd>
                    </dl>
                    ...
                    <dl>
                        ...
                        <dd><input type="text" name="passwd" id="" size="54" /></dd>
                    </dl>
                    
                    
                    <dl>
                        <dt><label for="password">First Name</label></dt>
                        <dd><input type="text" name="fname" id="" size="54" /></dd>
                    </dl>
                    
                    
                    <dl>
                        <dt><label for="password">Last Name</label></dt>
                        <dd><input type="text" name="lname" id="" size="54" /></dd>
                    </dl>
                    ...
                    <dl>
                        ...
                        <dd><input type="text" name="date_of_birth" id="" size="54" /></dd>
                    </dl>
    ...
    <div class="footer">
    	...
    	<div class="left_footer">Ask 4 U | Powered by : V & V Technologies</div>
