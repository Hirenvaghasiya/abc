...
<form action="user_profile.php" method="post">
    ...
    <td>Email</td>
    <td>:</td>
    <td><input type="text" name="fname" id="" class="tbox" value="<?php echo $res['email'];?>" /></td>
    </tr>
    <tr>
...
<div class="container_16">
  <div id="footer-register" class="grid_8" style="background-color:#CCC; width:1355px; height:30px; margin-left:-400px;">
  <center>
   <table>
   				<tr>
