...
<ul id="menu">
 ...
 ?>
  ...
  <!-- Emty Grid -->
  <div class="grid_5" style="margin-left:850px; margin-top:-180px">
...
<!--  -----------------------------------------------------------------------------------------------------------------------------------------  -->       
		...
		?>
           <li>
           <a href=""><?php echo "<img src=uploads/$res3[user_id].jpg alt=image height=50px width=50px>";?></a>
          ...
          <a style="margin-left:350px;" href="view_answer.php?id=<?php echo $res3['ans_id']; ?>" class="middle-button" 
...
<!--  -----------------------------------------------------------------------------------------------------------------------------------------  -->       
        ...
        <ul class="tab-menu-picture-list" style="float:left;  overflow-y:auto; height:300px">
          ...
          <a  href="view_answer.php?id=<?php echo $res4['que_id']; ?>" class="middle-button" style="float:right; margin-left:360px; margin-bottom:8px; margin-top:-18px;">
          			<span class="middle-right"></span>
             View Answer
           </a>
       </li>
...
<!--  -----------------------------------------------------------------------------------------------------------------------------------------  -->       
        ...
        <?php 
			...
			{			
		?>
          <li><span class="tab-date" style=" margin-top:-15px;"><?php echo $res1['date']; ?></span><a href="#" class="tab-menu-link" style=" margin-top:-15px;"><?php echo $res1['que_des']; ?></a><br/>
