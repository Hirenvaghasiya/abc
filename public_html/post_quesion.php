 ...
 <!--    <div class="search">
  ...
  <div class="grid_12 blog-page">
    ...
    <div id="post-blog-list-read" class="post-blog-read">
     ...
     <form action="Ask_question.php" method="post" name="post_que">
     <table>
     	<tr>
        	<td><b>Question</b></td>
            <td>:</td>
            <td><input type="text" name="title" width="80"  class="que"></td>
        </tr>
        ...
        <tr>
            ...
            <tr><td><input type="submit" name="que_submit" value="submit your question"  class="submit" 
    					style="width:170px; 
                        		height:35px; 
                                color:white;" /></td></tr>
             </table>
         ...
         <?php
				...
				if(isset($_POST['que_submit']))
				{
					...
					$file="../ASK4u/que_files/".$name.".$ext";
					move_uploaded_file($temp ,"../ASK4u/image/".$name.".$ext");
					$qry="insert into question values ('',1,$subject,'$que',0,'$date','$file','')";
        ...
        <table>
            	<tr>
                	<td><b>Email</b></td>
                  <td>:</td>
                  <td><input type="text"   class="queemail" /></td>
                </tr>
                <tr>
                	<td><b>Password</b></td>
                  <td>:</td>
                ...
                <td><p style="margin-left:70px;"><a href="#"> Forgot Your Password ? </a></p></td>
                </tr>
             </table>
...
<br />
<input  type="checkbox" name="terms" value="accept_terms"/> I've Read And Agree To the Terms Of USE And Privacy Policy.<br /><br />
   
    
     <a href="index.htm"> <input type="button" name="que_cancel" value="cancel ( Go Back )"  class="submit" 
    					style="width:170px; 
                        		height:35px; 
                                color:white;" /></a>
            </div></form>
