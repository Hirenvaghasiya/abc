...
<div id="main_container">
    ...
    <div class="right_header">Welcome <?php echo $_SESSION['admin']; ?>, <a href="http://www.ask4u.com/">Visit site</a> | <a href="#" class="messages">(3) Messages</a> | <a href="index.php?op=logout" class="logout">Logout</a></div>
    <div id="clock_a"></div>
    </div>
