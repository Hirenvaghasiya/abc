    ...
    <div id="post-blog-list-read" class="post-blog-read">
     ...
     <table>
        ...
        <tr>
            ...
            <tr><td colspan="3">
            <input  type="checkbox" name="terms" value="accept_terms"/> I've Read And Agree To the Terms Of USE And Privacy Policy.<br />
     ...
     <a href="index.php"> <input type="button" name="que_cancel" value="cancel ( Go Back )"  class="submit" 
				...
				if(isset($_POST['submit']))
				{
					...
					$qry1="insert into question values('',$_SESSION[user_id],$subject,'$que','$des',0,'$date','$file',0,'')";
