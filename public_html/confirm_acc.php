...
<li><a   href="All_questions.php"><u>All Answeres</a><!-- Begin Home Item -->
 ...
 <!-- <div class="grid_2 nav-button">
  ...
  <div class="grid_11 top-message"   style=" height:200px; margin-top:70px;">
    <h1><b>Confirm Your Account</b></h1>
  </div>
...
<div>
<form action="confirm_acc.php" method="post">
  	<table>
    ...
    <td>Enter Code</td>
    <td>:</td>
    <td colspan="2" align="left"><input type="text" name="txtcode" placeholder="Confirmation Code" required class="email" tabindex="1"/></td>
    </tr>
    <tr>
    <td colspan="4" align="center"><input type="submit" name="next_sub" value="Confirm" tabindex="2" /></td>
    </tr>
    </table>
    </form>
  </div>
